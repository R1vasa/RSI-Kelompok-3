            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <form action="{{ route('transaksi.update', $transaksi->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul_transaksi" class="bg-blue-100 opacity-60 w-full border rounded-full px-3 py-2"
                            value="{{ old('judul_transaksi', $transaksi->judul_transaksi) }}" palceholder="contoh: Nasi Pecel" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_kategori" class="bg-blue-100 opacity-60 w-full border rounded-full px-3 py-2" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="jenis_transaksi" class="bg-blue-100 opacity-60 w-full border rounded-full px-3 py-2" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="jumlah_transaksi" class="bg-blue-100 opacity-60 w-full border rounded-full px-3 py-2"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tgl_transaksi" class="bg-blue-100 opacity-60 w-full border rounded-full px-3 py-2"
