<!-- SIDEBAR NAVIGASI UTAMA — FinTrack Berisi menu navigasi utama untuk fitur keuangan pribadi dan organisasi. -->
<div class="bg-linear-to-t from-[#1C69E6] to-blue-500 h-dvh w-1/5 p-1 flex flex-col fixed">
    ...
    <!-- Kontainer menu (dapat di-scroll jika melebihi tinggi layar) -->
    <div class="flex-1 overflow-y-auto">
        ...
        <div class="space-y-4 pl-2 font-poppins font-semibold">
            ...
            <!-- Menu Navigasi Keuangan Pribadi -->
...
<!-- MODAL KONFIRMASI LOGOUT Muncul saat user menekan tombol logout untuk mencegah logout tidak sengaja. -->
...
<!-- LOGIKA JAVASCRIPT — Konfirmasi Logout & Modal Handling -->
<script>
    // Ambil elemen DOM
    ...
    // Saat tombol logout diklik → tampilkan modal konfirmasi
    ...
    // Jika user mengonfirmasi logout → kirim form ke route('logout')
