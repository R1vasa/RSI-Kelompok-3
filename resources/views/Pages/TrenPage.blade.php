    ...
    <div class="flex">
        ...
        <div class="flex-1 ml-[20%] min-h-screen">
            <div class="bg-white border-b border-gray-200 flex items-center justify-between px-6 py-4">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900 font-poppins">Anggaran</h1>
            ...
            <div id="chartsContainer" class="space-y-8">
                ...
                <div class="flex flex-wrap justify-center gap-8 mb-6">
                    {{-- Pie Pemasukan --}}
                    <div
                        class="bg-white shadow-md rounded-2xl p-6 w-[360px] border border-gray-100 hover:shadow-lg transition-all">
