<div class="bg-linear-to-t from-[#1C69E6] to-blue-500 h-dvh w-1/5 p-1 flex flex-col fixed">
        ...
        <div class="space-y-4 pl-2 font-poppins font-semibold">
            ...
            <nav class="space-y-4 pl-4 text-white">
                ...
                <a href="{{ route('transaksi.index') }}"
                    ...
                    <img width="20" height="20" src="https://img.icons8.com/forma-regular-filled/24/FFFFFF/data-in-both-directions--v2.png" alt="data-in-both-directions--v2"/>
                    Transaksi
                </a>
                
                <a href="/"
                   class="flex items-center gap-2 text-md font-medium hover:text-blue-200 transition duration-150">
                    <img width="20" height="20" src="https://img.icons8.com/forma-regular-filled/24/FFFFFF/money-bag.png" alt="money-bag"/>
                    Anggaran
                </a>

                <a href="{{ route('goals.index') }}"
                   class="flex items-center gap-2 text-md font-medium hover:text-blue-200 transition duration-150">
                   <img width="20" height="20" src="https://img.icons8.com/material-rounded/24/FFFFFF/goal.png" alt="goal"/>
                   Target Goals</a>

                <a href="/"
                    class="flex items-center gap-2 text-md font-medium hover:text-blue-200 transition duration-150">
                    <img width="20" height="20" src="https://img.icons8.com/forma-regular-filled/120/FFFFFF/document.png" alt="document"/>
                    Laporan</a>
            </nav>
        </div>
        ...
        <div class="space-y-4 pl-2 font-poppins font-semibold">
            ...
            <nav class="space-y-2 pl-4 text-white">
                ...
                <a href="{{ route('forum.index') }}"
                    class="flex items-center gap-2 text-md font-medium hover:text-blue-200 transition duration-150">
                    <img width="20" height="20" src="https://img.icons8.com/windows/32/FFFFFF/group-foreground-selected.png" alt="group-foreground-selected"/>
                    Forum Organisasi</a>
            </nav>
        </div>
    </div>
    <form action="{{ route('logout') }}" method="POST" class="flex justify-start items-center mt-auto p-8">
        ...
        <button type="submit" 
            ...
            <img width="20" height="20" src="https://img.icons8.com/fluency-systems-filled/24/FFFFFF/exit.png" alt="exit"/>
            Log out
        </button>
    </form>
</div>